...
case class HttpRequestAction(override val name:String,
                             ...
                             override val predecessor:Option[AbstractAction[Option[VertxRespType], VertxRespType]] = None) extends AbstractAction[Option[VertxRespType], VertxRespType] {
  ...
  /** Internal constructor for adding a predecessor. Basically a slightly modified copy constructor.
    ...
    */
  private def this(a: HttpRequestAction, newPredecessor:ABSTRACTACTION) = this(a.name, a.method, a.surl, a.body, a.client, a.params, a.headers, a.mappings, a.next, Some(newPredecessor))
  ...
  /** Adds a new header field to @code headers
    ...
    */
  def addHeader(header:(String,String)):HttpRequestAction = HttpRequestAction(name, method, surl, body, client, params, MapOps.add(this.headers, header), mappings, next, predecessor)
  ...
  /** Adds a list of new header fields to @code headers
    ...
    */
  def addHeaders(headers:List[(String,String)]):HttpRequestAction = HttpRequestAction(name, method, surl, body, client, params, MapOps.add(this.headers, headers), mappings, next, predecessor)
  ...
  /** Removes a given header field and returns the new instance of HttpAction
    ...
    */
  def removeHeader(name:String):HttpRequestAction = HttpRequestAction(name, method, surl, body, client, params, MapOps.remove(this.headers, name), mappings, next, predecessor)
  ...
  def next(httpAction: HttpRequestAction):HttpRequestAction = {
    ...
    HttpRequestAction(name, method, surl, body, client, params, headers, mappings, Some(newNext), predecessor)
  }
  ...
  /** Adds a new parameter to @code params
    ...
    */
  def addParam(param:(String, String)):HttpRequestAction = HttpRequestAction(name, method, surl, body, client, MapOps.add(this.params, param), headers, mappings, next, predecessor)
  ...
  /** Adds a list of parameters to @code params
    ...
    */
  def addParams(params:List[(String, String)]):HttpRequestAction = HttpRequestAction(name, method, surl, body, client, MapOps.add(this.params, params), headers, mappings, next, predecessor)
  ...
  /** Removes a given parameter from @code params
    ...
    * @return new HttpRequestAction instance with the modified parameters
    */
  def removeParam(name:String):HttpRequestAction = HttpRequestAction(name, method, surl, body, client, MapOps.remove(this.params, name), headers, mappings, next, predecessor)

  def body(newBody:String):ABSTRACTACTION = HttpRequestAction(name, method, surl, newBody, client, params, headers, mappings, next, predecessor)

  def url(newUrl:String):ABSTRACTACTION = HttpRequestAction(name, method, newUrl, body, client, params, headers, mappings, next, predecessor)
  ...
  override def mappings(newMappings: String): AbstractAction[Option[VertxRespType], VertxRespType] = HttpRequestAction(name, method, surl, body, client, params, headers, Some(newMappings), next, predecessor)
...
object HttpRequestAction {
  ...
  type ABSTRACTACTION = AbstractAction[Option[VertxRespType], VertxRespType]
